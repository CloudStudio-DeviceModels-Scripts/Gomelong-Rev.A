...
# Parsing + Configuration Script – Gomelong - Rev. A

This **Parsing + Configuration** script is designed for the **Gomelong** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – Gomelong Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **Gomelong** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
